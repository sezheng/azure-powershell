...
namespace Microsoft.Azure.Commands.Resources.Test.Models
{
    public class ResourceClientTests : TestBase
    {
        ...
        private void SetupListForResourceGroupAsync(string name, List<GenericResourceExtended> result)
        {
        ...
        public void NewResourceGroupChecksForPermissionForExistingResource()
        {
            ...
            resourceOperationsMock.Setup(f => f.ListAsync(It.IsAny<ResourceListParameters>(), It.IsAny<CancellationToken>()))
                .Returns(() => Task.Factory.StartNew(() => new ResourceListResult
                {
                    ...
                    Resources = new List<GenericResourceExtended>(new[]
                        {
                            new GenericResourceExtended
                            {
                                Name = "foo",
                                Properties = null,
        ...
        public void NewResourceGroupWithGalleryTemplateAndWithoutStorageAccountNameSucceeds()
        {
            ...
            resourceGroupMock.Setup(f => f.CreateOrUpdateAsync(
                parameters.ResourceGroupName,
                It.IsAny<ResourceGroupExtended>(),
                new CancellationToken()))
            ...
            SetupListForResourceGroupAsync(parameters.ResourceGroupName, new List<GenericResourceExtended>());
        ...
        public void NewResourceWithExistingResourceAsksForUserConfirmation()
        {
            ...
            resourceOperationsMock.Setup(f => f.GetAsync(resourceGroupName, It.IsAny<ResourceIdentity>(), It.IsAny<CancellationToken>()))
                .Returns(Task.Factory.StartNew(() => new ResourceGetResult
                    {
                        Resource = new GenericResourceExtended
                            {
                                Location = "West US",
        ...
        public void NewResourceWithAllParametersSucceeds()
        {
            ...
            resourceOperationsMock.Setup(f => f.CreateOrUpdateAsync(resourceGroupName, It.IsAny<ResourceIdentity>(), It.IsAny<GenericResource>(), It.IsAny<CancellationToken>()))
        ...
        public void SetResourceWithReplaceRewritesResource()
        {
            ...
            {
                Name = resourceIdentity.ResourceName,
                Id = resourceIdentity.ParentResourcePath,
                PropertyObject = new Hashtable(patchProperties),
                ResourceGroupName = resourceGroupName,
                ResourceType = resourceIdentity.ResourceProviderNamespace + "/" + resourceIdentity.ResourceType
            };

            var actual = new GenericResourceExtended();
            ...
            resourceOperationsMock.Setup(f => f.CreateOrUpdateAsync(resourceGroupName, It.IsAny<ResourceIdentity>(), It.IsAny<GenericResource>(), It.IsAny<CancellationToken>()))
                ...
                .Callback((string groupName, ResourceIdentity id, GenericResourceExtended p, CancellationToken token) => actual = p);
        ...
        {
            Uri templateUri = new Uri("http://templateuri.microsoft.com");
            var deploymentFromValidate = new Deployment();
        ...
        public void NewResourceGroupUsesDeploymentNameForDeploymentName()
        {
            ...
            var deploymentFromGet = new Deployment();
            var deploymentFromValidate = new Deployment();
            CreatePSResourceGroupParameters parameters = new CreatePSResourceGroupParameters()
            {
                ResourceGroupName = resourceGroupName,
        ...
        public void GetsOneResource()
        {
            ...
            var result = resourcesClient.FilterResources(options);
        ...
        public void GetsAllResourcesUsingResourceType()
        {
            ...
            var resource1 = new GenericResourceExtended() { Id = "resourceId", Location = resourceGroupLocation, Name = resourceName };
            var resource2 = new GenericResourceExtended() { Id = "resourceId2", Location = resourceGroupLocation, Name = resourceName + "2", };
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void GetsSpecificResourceGroupExtended()
        {
            string name = resourceGroupName;
            var resource1 = new GenericResourceExtended() { Id = "/subscriptions/abc123/resourceGroups/group1/providers/Microsoft.Test/servers/r12345sql/db/r45678db", Location = resourceGroupLocation, Name = resourceName };
            var resource2 = new GenericResourceExtended() { Id = "/subscriptions/abc123/resourceGroups/group1/providers/Microsoft.Test/servers/r12345sql/db/r45678db", Location = resourceGroupLocation, Name = resourceName + "2" };
            var resourceGroup = new ResourceGroupExtended() { Name = name, Location = resourceGroupLocation, ProvisioningState = "Succeeded" };
        ...
        {
            var resourceGroup1 = new ResourceGroupExtended() { Name = resourceGroupName + 1, Location = resourceGroupLocation };
            var resourceGroup2 = new ResourceGroupExtended() { Name = resourceGroupName + 2, Location = resourceGroupLocation };
            var resourceGroup3 = new ResourceGroupExtended() { Name = resourceGroupName + 3, Location = resourceGroupLocation };
            var resourceGroup4 = new ResourceGroupExtended() { Name = resourceGroupName + 4, Location = resourceGroupLocation };
        ...
        public void GetsResourceGroupsFilteredByTags()
        {
            ...
            var resourceGroup1 = new ResourceGroupExtended() { Name = resourceGroupName + 1, Location = resourceGroupLocation, Tags = tag1 };
            var resourceGroup2 = new ResourceGroupExtended() { Name = resourceGroupName + 2, Location = resourceGroupLocation, Tags = tag2 };
            var resourceGroup3 = new ResourceGroupExtended() { Name = resourceGroupName + 3, Location = resourceGroupLocation, Tags = tag3 };
            var resourceGroup4 = new ResourceGroupExtended() { Name = resourceGroupName + 4, Location = resourceGroupLocation };
            resourceGroupMock.Setup(f => f.ListAsync(null, new CancellationToken()))
                .Returns(Task.Factory.StartNew(() => new ResourceGroupListResult
                {
        ...
        //[Fact]
        //[Trait(Category.AcceptanceType, Category.CheckIn)]
        //public void GetAzureResourceGroupLogWithAllCallsListEventsForResourceGroupExtended()
        //{
